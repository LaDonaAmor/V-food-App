    ...
    <div class="hero-image">
      <div class="hero-text">
        <div class="box b" data-aos="zoom-in">
          ...
          <h1 class="h-text">Pick your ingredient and get your favorite food delivered hot & fresh 
          </h1>
          <p class="p-text">Healthy neat chefs do all the prep work, like peeding, choping & cutting, so you can cook a fresh food 
          </p>
          <button>Coming Soon
          </button>
        </div>
